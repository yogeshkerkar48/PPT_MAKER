...
2. If there are 50 points, there must be EXACTLY 50 slides.
...
- "bullet_points": The main details from that point (2-3 brief, impactful points).
  * IMPORTANT: If the content is a NUMERICAL PROBLEM or a QUESTION, you MUST include BOTH the full question and the step-by-step solution/answer in the bullet points. Do not summarize or omit the steps.
...
- "layout": ONE of ["center", "left", "right", "split_left", "split_right"].
...
4. LIMIT to maximum {max_slides} slides total.
